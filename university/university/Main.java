...
// Print university.Student
        ...
        // university.Student: John Smith, Astrology
...
// Dismiss university.Student
        ...
        System.out.println(dismissedTwo); // university.Student not found
// Get university.Student
        System.out.println(university.getStudent("Rihanna", "Fenty"));
// university.Student: Rihanna Fenty, Music
        System.out.println(university.getStudentCount()); // 3
        System.out.println(university.getStatistics());
//==university.Student: First Name = Anna, Last Name = Cameron, Best Subject = Geometry
        //==university.Student: First Name = Samy, Last Name = Johnson, Best Subject = Algebra
        //==university.Student: First Name = Rihanna, Last Name = Fenty, Best Subject = Music
